# -*- encoding: utf-8 -*-
"""
@File Name      :   homologene.py    
@Create Time    :   2022/5/20 17:35
@Description    :   
@Version        :   
@License        :   MIT
@Author         :   diklios
...
base_url = "https://www.ncbi.nlm.nih.gov/homologene/"


def get_human_gene_name(mouse_gene_name, html):
    human_gene_name_texts_re = re.compile(r'<a href.*H\.sapiens.*</a>')
    human_gene_name_texts = human_gene_name_texts_re.findall(html)
    if human_gene_name_texts:
        human_gene_name_text = human_gene_name_texts[0]
        human_gene_name_re = re.compile(r'>(.*),&#160;')
